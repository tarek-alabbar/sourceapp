...
#endif
                //HERE: This is the qurey
                IEnumerable<TodoItem> items = await todoTable.Where(todoItem => todoItem.Email == "testemail").ToEnumerableAsync();
                Debug.WriteLine("HELLO IM HERE: " + items.ToList().ToString());
