    ...
    public partial class TodoList : ContentPage
    {
        ...
        public async void OnSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            if (Device.RuntimePlatform != Device.iOS && todo != null)
            {
                ...
                {
                    string data = string.Format("Name: {0}. City: {1}. Job: {2}. Number: {3}. Email: {4}. Sons: {5}", todo.Name, todo.City, todo.Job, todo.Number, todo.Email, todo.Sons);
                    Debug.WriteLine( "Dubug todo: " + todo);
                    await DisplayAlert(todo.Name, data, "Got it!");
                }
                else
                {
